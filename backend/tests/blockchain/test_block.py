...
def test_quickly_mined_block():
    ...
    mined_block = Block.mine_block(last_block, 'res')
...
def test_mined_block_diff_limits_at_1():
    last_block = Block(
        time.time_ns(),
        'test_last_hash',
        'test_hash',
    ...
    mined_block = Block.mine_block(last_block, 'test')
...
def test_is_valid_bad_last_hash(last_block, block):
    block.last_hash = 'cause_problems'
...
def test_is_valid_jumped_diff(last_block, block):
    jumped_diff = 10
    block.difficulty = jumped_diff
    block.hash = f'{"0" * jumped_diff}11abc'
...
def test_is_valid_bad_block_hash(last_block, block):
    block.hash = '00000000000000000000000abcdefabcdef'
